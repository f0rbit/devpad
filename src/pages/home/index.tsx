...
const home: NextPage = () => {
    ...
    const getSubDomain = (sub: string) => {
        const host = (typeof window != 'undefined' ? window.location.hostname : "localhost:3000");
    ...
    return (
        <HomeLayout title={'Home Page'}>
            <CenteredContainer>
                ...
                <div className="relative mt-24 flex flex-row flex-nowrap mb-12">
                    <div className="relative left-0 w-24 justify-center hidden lg:flex ">
                    ...
                    <div className="">
                        ...
                        <ApplicationCard
                            ...
                            title={"Diary"}
                            description = {"Offers a comprehensive timeline. Shows a history of TODO completions, keep track of commitment and visual feedback on staying on track. See upcoming project & job dates, go back in time and see your history. Store life events and link files and images. See all your git commits together, and configure a custom media timeline."}
                            images={[]}
