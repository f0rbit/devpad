...
describe('projects API client integration', () => {
  ...
  test('should update an existing project', async () => {
    ...
    const updatedProject = await test_client.projects.update(createdProject.id, updatedData);
  ...
  test('should soft delete a project', async () => {
    ...
    const deletedProject = await test_client.projects.delete(createdProject.id);
