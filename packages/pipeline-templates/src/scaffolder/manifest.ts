...
export const SCAFFOLDER_TEMPLATES: TemplateEntry[] = [
	...
	{ template_path: ".oxfmtrc.json.hbs", relative_path: ".oxfmtrc.json" },
	{ template_path: ".oxlintrc.json.hbs", relative_path: ".oxlintrc.json" },
	{ template_path: "AGENTS.md.hbs", relative_path: "AGENTS.md" },
	{ template_path: "README.md.hbs", relative_path: "README.md" },
	{ template_path: "bunfig.toml.hbs", relative_path: "bunfig.toml" },
	...
	{ template_path: "eslint.config.ts.hbs", relative_path: "eslint.config.ts" },
