...
export class ApiClient {
  ...
  constructor(options: {
    ...
    this._auth_mode =
      options.auth_mode ??
      (options.api_key?.startsWith("jwt:")
        ? "session"
        : options.api_key
          ? "key"
          : "cookie");
  ...
  public readonly auth = {
    session: (): Promise<
      ApiResult<{ authenticated: boolean; user: any; session: any }>
    > =>
      wrap(() =>
    ...
    keys: {
      list: (): Promise<ApiResult<ApiKey[]>> =>
        wrap(() => this.clients.auth.get<ApiKey[]>("/keys")),

      create: (
        name?: string,
      ): Promise<ApiResult<{ message: string; key: string }>> =>
        wrap(() =>
      ...
      revoke: (
        ...
        wrap(() =>
          this.clients.auth.delete<{ message: string; success: boolean }>(
            `/keys/${key_id}`,
          ),
        ),
  ...
  public readonly projects = {
    ...
    list: (filters?: { private?: boolean }): Promise<ApiResult<Project[]>> =>
      wrap(() =>
        this.clients.projects.get<Project[]>(
    ...
    find: (id: string): Promise<ApiResult<Project | null>> =>
      wrap(() =>
        this.clients.projects.get<any>("/projects", { query: { id } }),
      ),
    ...
    getByName: (name: string): Promise<ApiResult<Project>> =>
      wrap(() =>
        this.clients.projects.get<Project>("/projects", { query: { name } }),
      ),
    ...
    getById: (id: string): Promise<ApiResult<Project>> =>
      wrap(() =>
        this.clients.projects.get<Project>("/projects", { query: { id } }),
      ),
    ...
    create: (data: Omit<UpsertProject, "id">): Promise<ApiResult<Project>> =>
      wrap(() =>
        this.clients.projects.patch<Project>("/projects", { body: data }),
      ),
    ...
    history: (project_id: string): Promise<ApiResult<any[]>> =>
      wrap(() =>
        this.clients.projects.get<any[]>(`/projects/${project_id}/history`),
      ),
  ...
  public readonly milestones = {
    ...
    list: (): Promise<ApiResult<Milestone[]>> =>
      wrap(() => this.clients.milestones.get<any[]>("/milestones")),
    ...
    getByProject: (project_id: string): Promise<ApiResult<Milestone[]>> =>
      wrap(() =>
        this.clients.milestones.get<any[]>(
    ...
    create: (data: {
      ...
      wrap(() =>
        this.clients.milestones.post<any>("/milestones", { body: data }),
      ),
    ...
    delete: (
      ...
      wrap(() =>
        this.clients.milestones.delete<{ success: boolean; message: string }>(
          `/milestones/${id}`,
        ),
      ),
  ...
  public readonly goals = {
    ...
    list: (): Promise<ApiResult<Goal[]>> =>
      wrap(() => this.clients.goals.get<any[]>("/goals")),

    /**
     * Get goal by ID
     */
    find: (id: string): Promise<ApiResult<Goal | null>> =>
      wrap(() => this.clients.goals.get<any>(`/goals/${id}`)),
    ...
    create: (data: {
      ...
      wrap(() => this.clients.goals.post<any>("/goals", { body: data })),
    ...
    update: async (
      id: string,
      data: { name?: string; description?: string; target_time?: string },
    ): Promise<ApiResult<Goal>> =>
      wrap(async () => {
    ...
    delete: (
      ...
      wrap(() =>
        this.clients.goals.delete<{ success: boolean; message: string }>(
          `/goals/${id}`,
        ),
      ),
  };
  ...
  public readonly tasks = {
    ...
    list: (filters?: {
      ...
      wrap(() => {
        ...
        return this.clients.tasks.get<TaskWithDetails[]>(
          "/tasks",
     ...
     */
    create: (
      data: Omit<UpsertTodo, "id"> & { tags?: UpsertTag[] },
    ): Promise<ApiResult<TaskWithDetails>> =>
      wrap(() =>
        this.clients.tasks.patch<TaskWithDetails>("/tasks", { body: data }),
      ),
     ...
     */
    upsert: (
      data: UpsertTodo & { tags?: UpsertTag[] },
    ): Promise<ApiResult<TaskWithDetails>> =>
      wrap(() =>
        this.clients.tasks.patch<TaskWithDetails>("/tasks", { body: data }),
      ),
    ...
    saveTags: (data: any): Promise<ApiResult<void>> =>
      wrap(() =>
        this.clients.tasks.patch<void>("/tasks/save_tags", { body: data }),
      ),
    ...
    history: {
      ...
      get: (task_id: string): Promise<ApiResult<HistoryAction[]>> =>
        wrap(() =>
          this.clients.tasks.get<HistoryAction[]>(`/tasks/history/${task_id}`),
        ),
    },
  };
  ...
  public readonly github = {
    ...
    repos: (): Promise<ApiResult<any[]>> =>
      wrap(() => this.clients.github.get<any[]>("/repos")),
    ...
    branches: (owner: string, repo: string): Promise<ApiResult<any[]>> =>
      wrap(() =>
        this.clients.github.get<any[]>(`/repos/${owner}/${repo}/branches`),
      ),
  };
  ...
  public readonly blog = {
    posts: {
      ...
      update: (uuid: string, data: PostUpdate): Promise<ApiResult<Post>> =>
        wrap(() =>
          this.clients.blog.put<Post>(`/blog/posts/${uuid}`, { body: data }),
        ),

      delete: (uuid: string): Promise<ApiResult<{ success: boolean }>> =>
        wrap(() =>
          this.clients.blog.delete<{ success: boolean }>(`/blog/posts/${uuid}`),
        ),

      versions: (
        uuid: string,
      ): Promise<ApiResult<{ versions: VersionInfo[] }>> =>
        wrap(() =>
          this.clients.blog.get<{ versions: VersionInfo[] }>(
      ...
      version: (uuid: string, hash: string): Promise<ApiResult<PostContent>> =>
        wrap(() =>
          this.clients.blog.get<PostContent>(
      ...
      restore: (uuid: string, hash: string): Promise<ApiResult<Post>> =>
        wrap(() =>
          this.clients.blog.post<Post>(`/blog/posts/${uuid}/restore/${hash}`),
        ),
    },
    ...
    tags: {
      list: (): Promise<ApiResult<{ tags: TagWithCount[] }>> =>
        wrap(() =>
          this.clients.blog.get<{ tags: TagWithCount[] }>("/blog/tags"),
        ),

      getForPost: (uuid: string): Promise<ApiResult<{ tags: string[] }>> =>
        wrap(() =>
          this.clients.blog.get<{ tags: string[] }>(
      ...
      setForPost: (
        uuid: string,
        tags: string[],
      ): Promise<ApiResult<{ tags: string[] }>> =>
        wrap(() =>
          this.clients.blog.put<{ tags: string[] }>(
            `/blog/tags/posts/${uuid}/tags`,
            { body: { tags } },
          ),
        ),
      ...
      addToPost: (
        ...
        wrap(() =>
          this.clients.blog.post<{ tags: string[] }>(
            `/blog/tags/posts/${uuid}/tags`,
            { body: { tags } },
          ),
        ),
    ...
    categories: {
      tree: (): Promise<ApiResult<{ categories: Category[] }>> =>
        wrap(() =>
          this.clients.blog.get<{ categories: Category[] }>("/blog/categories"),
        ),

      create: (data: CategoryCreate): Promise<ApiResult<Category>> =>
        wrap(() =>
          this.clients.blog.post<Category>("/blog/categories", { body: data }),
        ),
    ...
    tokens: {
      list: (): Promise<ApiResult<{ tokens: SanitizedToken[] }>> =>
        wrap(() =>
          this.clients.blog.get<{ tokens: SanitizedToken[] }>("/blog/tokens"),
        ),

      create: (data: AccessKeyCreate): Promise<ApiResult<CreatedToken>> =>
        wrap(() =>
          this.clients.blog.post<CreatedToken>("/blog/tokens", { body: data }),
        ),

      update: (
        id: string,
        data: AccessKeyUpdate,
      ): Promise<ApiResult<AccessKey>> =>
        wrap(() =>
  ...
  public readonly media = {
    profiles: {
      list: (): Promise<ApiResult<Profile[]>> =>
        wrap(async () => {
          const res = await this.clients.media.get<{ profiles: Profile[] }>(
            "/profiles",
          );
          return res.profiles;
        }),
      ...
      create: (data: CreateProfileInput): Promise<ApiResult<Profile>> =>
        wrap(() =>
          this.clients.media.post<Profile>("/profiles", { body: data }),
        ),

      get: (id: string): Promise<ApiResult<Profile>> =>
        wrap(() => this.clients.media.get<Profile>(`/profiles/${id}`)),
      ...
      update: (
        ...
        wrap(() =>
          this.clients.media.patch<Profile>(`/profiles/${id}`, { body: data }),
        ),

      delete: (id: string): Promise<ApiResult<{ success: boolean }>> =>
        wrap(() =>
          this.clients.media.delete<{ success: boolean }>(`/profiles/${id}`),
        ),
      ...
      filters: {
        ...
        add: (
          profile_id: string,
          data: AddFilterInput,
        ): Promise<ApiResult<ProfileFilter>> =>
          wrap(() =>
            this.clients.media.post<ProfileFilter>(
              `/profiles/${profile_id}/filters`,
              { body: data },
            ),
          ),
        ...
        remove: (
          ...
          wrap(() =>
            this.clients.media.delete<void>(
    ...
    connections: {
      list: (
        profile_id: string,
        options?: { include_settings?: boolean },
        ...
        wrap(async () => {
          ...
          const res = await this.clients.media.get<{ accounts: Account[] }>(
            "/connections",
            { query },
          );
          return res.accounts;
      ...
      create: (data: {
        ...
        wrap(() =>
          this.clients.media.post<Account>("/connections", { body: data }),
        ),

      delete: (account_id: string): Promise<ApiResult<{ success: boolean }>> =>
        wrap(() =>
          this.clients.media.delete<{ success: boolean }>(
      ...
      refresh: (account_id: string): Promise<ApiResult<any>> =>
        wrap(() =>
          this.clients.media.post<any>(`/connections/${account_id}/refresh`),
        ),

      refreshAll: (): Promise<ApiResult<any>> =>
        wrap(() => this.clients.media.post<any>("/connections/refresh-all")),
      ...
      settings: {
        get: (account_id: string): Promise<ApiResult<PlatformSettings>> =>
          wrap(() =>
            this.clients.media.get<PlatformSettings>(
      ...
      repos: (account_id: string): Promise<ApiResult<any[]>> =>
        wrap(async () => {
          const res = await this.clients.media.get<{ repos: any[] }>(
    ...
    credentials: {
      ...
      save: (
        ...
        wrap(() =>
          this.clients.media.post<{ success: boolean; id: string }>(
  ...
  public readonly user = {
    ...
    history: (): Promise<ApiResult<any[]>> =>
      wrap(() => this.clients.auth.get<any[]>("/user/history")),
    ...
    preferences: (data: {
      ...
      wrap(() =>
        this.clients.auth.patch<any>("/user/preferences", { body: data }),
      ),
  };
