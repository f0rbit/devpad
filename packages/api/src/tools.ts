...
export const project_filters = z.object({
  private: z
    .boolean()
    .optional()
    .describe("Include private projects (default: true)"),
});
...
export const tools: Record<string, ToolDefinition> = {
  ...
  devpad_projects_get: {
    ...
    execute: async (client, input) =>
      unwrap(
        input.id
          ? await client.projects.getById(input.id)
          : await client.projects.getByName(input.name!),
      ),
  },
  ...
  devpad_projects_upsert: {
    ...
    execute: async (client, input) =>
      unwrap(await client.projects.upsert(input)),
  },
  ...
  devpad_milestones_list: {
    ...
    execute: async (client, input) =>
      unwrap(
        input.project_id
          ? await client.milestones.getByProject(input.project_id)
  ...
  devpad_milestones_get: {
    ...
    execute: async (client, input) =>
      unwrap(await client.milestones.find(input.id)),
  },
  ...
  devpad_github_branches: {
    ...
    execute: async (client, input) =>
      unwrap(await client.github.branches(input.owner, input.repo)),
  },
  ...
  devpad_projects_history: {
    ...
    execute: async (client, input) =>
      unwrap(await client.projects.history(input.project_id)),
  },
  ...
  devpad_projects_specification: {
    ...
    execute: async (client, input) =>
      unwrap(await client.projects.specification(input.project_id)),
  },
  ...
  devpad_projects_config_load: {
    ...
    execute: async (client, input) =>
      unwrap(await client.projects.config.load(input.project_id)),
  },
  ...
  devpad_milestones_delete: {
    ...
    execute: async (client, input) =>
      unwrap(await client.milestones.delete(input.id)),
  },
  ...
  devpad_milestones_goals: {
    ...
    execute: async (client, input) =>
      unwrap(await client.milestones.goals(input.id)),
  },
  ...
  devpad_goals_delete: {
    ...
    execute: async (client, input) =>
      unwrap(await client.goals.delete(input.id)),
  },
  ...
  devpad_tasks_history: {
    ...
    execute: async (client, input) =>
      unwrap(await client.tasks.history.get(input.task_id)),
  },
  ...
  devpad_user_preferences: {
    ...
    execute: async (client, input) =>
      unwrap(await client.user.preferences(input)),
  },
  ...
  devpad_blog_posts_list: {
    ...
    execute: async (client, input) =>
      unwrap(await client.blog.posts.list(input)),
  },
  ...
  devpad_blog_posts_get: {
    ...
    execute: async (client, input) =>
      unwrap(await client.blog.posts.getBySlug(input.slug)),
  },
  ...
  devpad_blog_posts_create: {
    ...
    inputSchema: z.object({
      ...
      project_ids: z
        .array(z.string())
        .optional()
        .describe("Associated project IDs"),
      archived: z.boolean().optional().describe("Whether post is archived"),
    }),
    execute: async (client, input) =>
      unwrap(await client.blog.posts.create(input)),
  },
  ...
  devpad_blog_posts_delete: {
    ...
    execute: async (client, input) =>
      unwrap(await client.blog.posts.delete(input.uuid)),
  },
  ...
  devpad_blog_categories_create: {
    ...
    execute: async (client, input) =>
      unwrap(await client.blog.categories.create(input)),
  },
  ...
  devpad_blog_tokens_create: {
    ...
    execute: async (client, input) =>
      unwrap(await client.blog.tokens.create(input)),
  },
  ...
  devpad_media_profiles_create: {
    ...
    execute: async (client, input) =>
      unwrap(await client.media.profiles.create(input)),
  },
  ...
  devpad_media_profiles_get: {
    ...
    execute: async (client, input) =>
      unwrap(await client.media.profiles.get(input.id)),
  },
  ...
  devpad_media_profiles_delete: {
    ...
    execute: async (client, input) =>
      unwrap(await client.media.profiles.delete(input.id)),
  },
  ...
  devpad_media_connections_list: {
    ...
    execute: async (client, input) =>
      unwrap(await client.media.connections.list(input.profile_id)),
  },
  ...
  devpad_media_connections_refresh: {
    ...
    execute: async (client, input) =>
      unwrap(await client.media.connections.refresh(input.account_id)),
  },
