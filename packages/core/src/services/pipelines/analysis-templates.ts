 ...
 */
export const list_analysis_templates = async (
	db: Database,
	filter: ListAnalysisTemplatesFilter,
): Promise<Result<PipelineAnalysisTemplate[], ServiceError>> => {
	try {
		const rows = await db
			.select()
			.from(pipeline_analysis_template)
			.where(eq(pipeline_analysis_template.owner_id, filter.owner_id));
		return ok(rows);
	} catch (e) {
		return err({
			kind: "db_error",
 ...
 */
export const get_analysis_template = async (
	db: Database,
 ...
 */
export const create_analysis_template = async (
	db: Database,
 ...
 * `validation_error`.
 */
export const update_analysis_template = async (
	db: Database,
 ...
 */
export const delete_analysis_template = async (
	db: Database,
