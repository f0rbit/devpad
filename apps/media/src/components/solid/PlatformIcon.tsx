import { Github, Info, NotebookText, Youtube } from "lucide-solid";
...
function TwitterIcon(props: { size: number }) {
	return (
		<svg class="twitter-icon" xmlns="http://www.w3.org/2000/svg" width={props.size} height={props.size} viewBox="0 0 24 24" fill="currentColor">
