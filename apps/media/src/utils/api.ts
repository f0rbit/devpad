import type { CommentPayload, CommitGroup, CommitPayload, DateGroup, GitHubRepo, PlatformSettings, PostPayload, PRCommit, PullRequestPayload, TimelineItem, TimelineType } from "@devpad/schema/media";
import { err, ok, type Result } from "@f0rbit/corpus/types";
import { isDevMode, MOCK_API_KEY, MOCK_USER_ID } from "./mock-auth";
